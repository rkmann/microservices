...
public class MoviesClient {
    ...
    public void setUp(){
        MovieFixtures movieFixtures = new MovieFixtures();
        List<MovieInfo> movies = movieFixtures.load();
    ...
    public void addMovie(MovieInfo movie) {
        restOperations.postForEntity(URLEncoder.encode(moviesUrl), movie, MovieInfo.class);
    }

    public void deleteMovieId(Long movieId) {
        restOperations.delete(URLEncoder.encode(moviesUrl + "/" + movieId));
    }
